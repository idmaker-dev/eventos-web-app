...
export default function Pagos({ darkMode }) {
  const data = [
    { nombre: "Ana Sofía Garza", pagado: 1500, total: 20000, estado: "Pendiente", accion: "Verificar Comprobante" },
    { nombre: "Carlos Martínez", pagado: 2000, total: 20000, estado: "Aprobado", accion: "Ver historial" },
    { nombre: "David Jiménez", pagado: 5000, total: 20000, estado: "Parcial", accion: "Ver historial" },
    { nombre: "Víctor Ocampo", pagado: 2000, total: 20000, estado: "Aprobado", accion: "Verificar Comprobante" },
    { nombre: "Juan Antonio", pagado: 2000, total: 20000, estado: "Aprobado", accion: "Ver historial" },
