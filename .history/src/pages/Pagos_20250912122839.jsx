...
import { CheckCircle, AlertCircle, XCircle } from "lucide-react"; // íconos
...
export default function Pagos() {
  ...
  const getBarraColor = (estado) => {
    if (estado === "Pendiente") return "#f2c94c";
    if (estado === "Aprobado") return "#27ae60";
    if (estado === "Parcial") return "#6c757d";
    return "#6fcf97";
  };
