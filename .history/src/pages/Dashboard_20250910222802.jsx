  ...
  <div className="dashboard-metrica">
    ...
    <div className="metric-circle">
      <div className="circle-wrapper">
        ...
        />
        {/* Contenido centrado manualmente */}
...
<div className="dashboard-acciones">
  ...
  <div className="dashboard-tabla">
    ...
    <div className="dashboard-fila alerta">
      <div className="col-tipo"><span className="icon">⚠</span> Pago Pendiente</div>
    ...
    <div className="dashboard-fila conflicto">
      <div className="col-tipo"><span className="icon">ℹ</span> Conflicto de asignación</div>
