...
export default function Pagos({ darkMode }) {
  const data = [
    { nombre: "Ana Sofía Garza", pagado: 15000, estado: "Pendiente", accion: "Verificar Comprobante" },
    { nombre: "Carlos Martínez", pagado: 20000, estado: "Aprobado", accion: "Ver historial" },
    { nombre: "David Jiménez", pagado: 5000, estado: "Parcial", accion: "Ver historial" },
    { nombre: "Víctor Ocampo", pagado: 20000, estado: "Aprobado", accion: "Verificar Comprobante" },
    { nombre: "Juan Antonio", pagado: 20000, estado: "Aprobado", accion: "Ver historial" },
    { nombre: "Javier Lara Flores", pagado: 12000, estado: "Pendiente", accion: "Verificar Comprobante" },
    { nombre: "Esmeralda Jiménez", pagado: 3000, estado: "Parcial", accion: "Ver historial" },
  ];

  // Total fijo en 20,000
  const total = 20000;
  ...
  return (
    <div className={`pagos-container ${darkMode ? "dark" : ""}`}>
      ...
      <div className="pagos-tabla">
        ...
        {data.map((item, idx) => {
          const porcentaje = (item.pagado / total) * 100;
          return (
            <div key={idx} className={`pagos-fila ${idx % 2 === 0 ? "fila-par" : "fila-impar"}`}>
              ...
              <div className="col" data-label="Total pagado">
                ${item.pagado.toLocaleString()}/{total.toLocaleString()}
              </div>
