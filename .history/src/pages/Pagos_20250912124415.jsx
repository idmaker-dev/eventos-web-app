...
import { CheckCircle, AlertCircle, XCircle } from "lucide-react"; // iconos
...
export default function Pagos() {
  ...
  const getBarraColor = (estado) => {
    if (estado === "Pendiente") return "#f2c94c"; // amarillo
    if (estado === "Aprobado") return "#2ecc71"; // verde
    if (estado === "Parcial") return "#95a5a6"; // gris
    return "#6fcf97";
  };
