      ...
      <main className="main">
        ...
        <aside className="sidebar">
          ...
          <input
            ...
            onChange={(e) =>
              _handleRestriccionChange("vegano", e.target.value)
            }
          />
          ...
          <input
            ...
            onChange={(e) =>
              _handleRestriccionChange("mariscos", e.target.value)
            }
          />
          ...
          <input
            ...
            onChange={(e) =>
              _handleRestriccionChange("otros", e.target.value)
            }
          />
        ...
        <section className="preview">
          ...
          <div className="phone">
            <div className="phone-screen">
              ...
              <p>{formData.escuela || "Instituto Villa Rica"}</p>
              <p className="desc">{formData.nombreEvento}</p>
              <p className="detalle">{formData.descripcion}</p>
              <p className="detalle">
          ...
          <div className="phone">
            <div className="phone-screen">
              ...
              <label>Cantidad de boletos requeridos</label>
              <input type="number" placeholder="0" value={formData.boletos} readOnly />
              ...
              <div className="restricciones-box">
                ...
                {formData.restricciones.otros && (
                  <p>Otros: {formData.restricciones.otros}</p>
                )}
              </div>
