            ...
            <div className="flex-1">
              ...
              >
                ...
                <div className="flex space-x-2">
                  <button className="px-3 py-1 text-sm rounded-md text-white bg-Acapulco hover:opacity-90 transition">
                    Editar
                  </button>
                  <button className="px-3 py-1 text-sm rounded-md text-white bg-gray-400 hover:opacity-90 transition">
                    Eliminar
                  </button>
                </div>
              </div>
