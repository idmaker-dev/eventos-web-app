...
export default function ConfigurarRespuesta() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6">
      {/* Botón agregar nueva */}
      <div className="mb-4">
  <button className="bg-Acapulco text-white px-3 py-1.5 rounded-full font-medium hover:opacity-90 transition text-sm">
  ...
  <button className="px-3 py-1 text-sm rounded text-white bg-Acapulco hover:opacity-90 transition">
    Editar
  </button>
  <button className="px-3 py-1 text-sm rounded text-white bg-grey hover:opacity-90 transition">
    Eliminar
  </button>
</div>
