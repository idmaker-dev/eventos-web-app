...
export default function ConfigurarRespuesta() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6">
      {/* Botón agregar nueva */}
      <div className="mb-4">
        <button className="bg-Acapulco text-white px-4 py-2 rounded-md font-medium hover:opacity-90 transition text-sm">
      ...
      <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2">
        {preguntas.map((p, i) => (
          <div
            key={p.id}
            className="border rounded-md bg-white overflow-hidden flex"
          >
            {/* Número a la izquierda */}
            <div className="bg-gray-50 px-5 flex items-center justify-center border-r text-gray-600 font-semibold text-lg w-14">
              {i + 1}
            </div>
            ...
            <div className="flex-1">
              ...
              >
                ...
                <div className="flex space-x-2">
                  <button className="px-4 py-1 text-sm rounded-md text-white bg-Acapulco hover:opacity-90 transition">
                    Editar
                  </button>
                  <button className="px-4 py-1 text-sm rounded-md text-white bg-gray-400 hover:opacity-90 transition">
                    Eliminar
                  </button>
                </div>
              </div>
