...
export default function ConfigurarRespuesta() {
  ...
  const [abiertos, setAbiertos] = useState([1, 2]); // 👈 por defecto abre 1 y 2
      ...
      <div className="space-y-3">
        {preguntas.map((p, i) => (
          ...
          >
            ...
            <div className="bg-gray-50 px-6 flex items-center justify-center border-r text-gray-600 font-bold text-2xl w-14">
              {i + 1}
            </div>
