...
import { Settings, Bell, Pin, User } from "lucide-react";
    ...
    <aside className="hidden lg:flex fixed left-0 top-0 h-screen w-[130px] flex-col justify-between items-center py-6 z-50">
      ...
      <nav className="bg-white dark:bg-[#2a2a2a] px-1 py-1 rounded-full shadow-md">
        <ul className="space-y-3">
          <li className="group relative">
            ...
            {/* Tooltip */}
            <span className="absolute left-16 top-1/2 -translate-y-1/2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-sm rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 whitespace-nowrap z-50 pointer-events-none">
              Inicio
          ...
          <li className="group relative">
            ...
            >
              <img src={ResumenProgreso} alt="Resumen y progreso" className="w-6 h-6" />
            </NavLink>
            <span className="absolute left-16 top-1/2 -translate-y-1/2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-sm rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 whitespace-nowrap z-50 pointer-events-none">
              Resumen y progreso
              <span className="absolute right-full top-1/2 -translate-y-1/2 border-4 border-transparent border-r-gray-900 dark:border-r-gray-700"></span>
          ...
          <li className="group relative">
            ...
            >
              <img src={ModuloPagos} alt="Módulo de pagos" className="w-6 h-6" />
            </NavLink>
            <span className="absolute left-16 top-1/2 -translate-y-1/2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-sm rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 whitespace-nowrap z-50 pointer-events-none">
              Módulo de pagos
              <span className="absolute right-full top-1/2 -translate-y-1/2 border-4 border-transparent border-r-gray-900 dark:border-r-gray-700"></span>
          ...
          <li className="group relative">
            ...
            >
              <img src={ModuloInvitados} alt="Módulo de invitados" className="w-6 h-6" />
            </NavLink>
            <span className="absolute left-16 top-1/2 -translate-y-1/2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-sm rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 whitespace-nowrap z-50 pointer-events-none">
          ...
          <li className="group relative">
            ...
            >
              <img src={ModuloAsignacion} alt="Módulo de comunicación" className="w-6 h-6" />
            </NavLink>
            <span className="absolute left-16 top-1/2 -translate-y-1/2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-sm rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 whitespace-nowrap z-50 pointer-events-none">
      ...
      <div className="bg-white dark:bg-[#2a2a2a] px-1 py-1 rounded-full shadow-md space-y-3 relative z-[60]">
        ...
        <div className="relative" ref={configMenuRef}>
          ...
          {configMenuOpen && (
            <>
              <div className="fixed inset-0 z-[98]" onClick={() => setConfigMenuOpen(false)} />
