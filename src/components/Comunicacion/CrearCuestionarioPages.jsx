...
export default function CrearCuestionarioPages({ onClose }) {
  ...
  return (
    <div className="relative rounded-xl border-2 bg-white dark:bg-fodoBlack  shadow-md">
      <button
        className=" absolute -top-4 -right-4 z-20 px-2 py-2  rounded-full bg-casal text-white font-semibold"
        onClick={onClose}
      >
        <X></X>
      </button>
      <div className="grid grid-cols-1  lg:grid-cols-3 md:gap-0 ">
                ...
                <Field>
                  ...
                  <div className="mb-3">
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        handleInputChange("descripcionEvento", e.target.value)
                      }
                      className={clsx(
                  ...
                  <div className="mb-3">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("fechaHoraEvento", e.target.value)
                      }
                      className={clsx(
                        "mt-2 block w-full rounded-3xl border-2 bg-white/5 px-3 py-1.5 text-sm/6 dark:text-white text-gray-700",
                        "placeholder:italic",
              ...
              <Field>
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("carreraEstudios", e.target.value)
                    }
                    className={clsx(
                      "mt-2 block w-full rounded-3xl border-2 bg-white/5 px-3 py-1.5 text-sm/6 dark:text-white text-gray-700",
                      "placeholder:italic",
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("escuelaInstitucion", e.target.value)
                    }
                    className={clsx(
                      "mt-2 block w-full rounded-3xl border-2 bg-white/5 px-3 py-1.5 text-sm/6 dark:text-white text-gray-700",
                      "placeholder:italic",
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("cantidadBoletos", e.target.value)
                    }
                    className={clsx(
                      "mt-2 block w-full rounded-3xl border-2 bg-white/5 px-3 py-1.5 text-sm/6 dark:text-white text-gray-700",
                      "placeholder:italic",
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("contactoEmergencia", e.target.value)
                    }
                    className={clsx(
                      "mt-2 block w-full rounded-3xl border-2 bg-white/5 px-3 py-1.5 text-sm/6 dark:text-white text-gray-700",
                      "placeholder:italic",
                  ...
                  <div className="p-4 border-2 rounded-2xl bg-transparent border-[#bcd6e4]">
                    <div className="mb-3">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("tutorNombre", e.target.value)
                        }
                        className={clsx(
                          "mt-2 block w-full rounded-3xl border-2 bg-white/5 px-3 py-1.5 text-sm/6 dark:text-white text-gray-700",
                          "placeholder:italic",
        ...
        <div
          className={clsx(
            "md:col-span-2  h-[85vh] overflow-y-auto  lg:border-l-2 bg-[#5c8287] dark:bg-[#2a9d8f]/5 rounded-r-xl p-4 relative",
        ...
        >
          {/* <div className="absolute top-0 left-0 flex space-x-2 z-10">
            <Button
              ...
              className={clsx(
                "p-2 bg-casal text-white hover:bg-casal/80 transition shadow-sm relative group",
                Ocultar ? "rounded-br-lg rounded-tl-xl " : "rounded-br-lg"
              )}
            >
              {!Ocultar ? (
              ...
              {Ocultar ? (
                <span className="absolute left-16 -translate-x-1/2 -bottom-8 z-10 whitespace-nowrap rounded bg-gray-800 px-2 py-1 text-xs text-white opacity-0 group-hover:opacity-100 transition">
                  Mostrar formulario
                </span>
              ) : (
                <span className="absolute left-16 -translate-x-1/2 -bottom-8 z-10 whitespace-nowrap rounded bg-gray-800 px-2 py-1 text-xs text-white opacity-0 group-hover:opacity-100 transition">
