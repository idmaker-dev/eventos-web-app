...
const FileUploader = ({ onFileSelect, onAttachmentMenuToggle, showAttachmentMenu, disabled }) => {
  ...
  return (
    <div className="relative">
      ...
      {/* Botón principal */}
      <button
        onClick={() => !disabled && onAttachmentMenuToggle(!showAttachmentMenu)}
        disabled={disabled}
        ...
        title={disabled ? "No disponible (Ticket cerrado)" : "Adjuntar archivo"}
      >
